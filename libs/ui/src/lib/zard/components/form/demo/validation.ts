...
@Component({
  selector: 'z-demo-form-validation',
  imports: [
    ReactiveFormsModule,
    ZardButtonComponent,
    ZardInputDirective,
    ...
    >
      <z-form-field>
        ...
        <z-form-control>
          <input
            ...
            [zStatus]="
              nameControl.invalid && nameControl.touched ? 'error' : undefined
            "
          />
        </z-form-control>
        ...
        <z-form-message zType="error"
          >Name must be at least 2 characters long.</z-form-message
        >
        } @else {
      ...
      <z-form-field>
        ...
        <z-form-control>
          <input
            ...
            [zStatus]="
              emailControl.invalid && emailControl.touched ? 'error' : undefined
            "
          />
        </z-form-control>
        ...
        <z-form-message zType="error"
          >Please enter a valid email address.</z-form-message
        >
        } @else {
      ...
      <z-form-field>
        ...
        <z-form-message zType="error"
          ...
          https://</z-form-message
        >
        } @else if (websiteControl.valid && websiteControl.touched &&
        websiteControl.value) {
        <z-form-message zType="success">Valid website URL!</z-form-message>
        } @else {
        <z-form-message
          >Optional: Your website or portfolio URL.</z-form-message
        >
        }
      </z-form-field>
      ...
      <div class="flex gap-2">
        ...
        <button z-button zType="outline" type="button" (click)="reset()">
          Reset
        </button>
      </div>

      @if (submitted) {
      <z-form-message zType="success" class="block"
        >Form submitted successfully! ✓</z-form-message
      >
      }
    </form>
  `,
