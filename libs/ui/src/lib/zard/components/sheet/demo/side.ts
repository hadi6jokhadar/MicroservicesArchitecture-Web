...
import { ZardRadioComponent } from '../../../components/radio';
import { ZardSheetImports } from '../../../components/sheet/sheet.imports';
import {
  Z_SHEET_DATA,
  ZardSheetService,
} from '../../../components/sheet/sheet.service';
  ...
  template: `
    <div class="flex flex-col justify-center space-y-6">
      <div class="flex space-x-4">
        ...
        <span z-radio name="bottom" [(ngModel)]="placement" value="bottom"
          >bottom</span
        >
        <span z-radio name="left" [(ngModel)]="placement" value="left"
          >left</span
        >
        <span z-radio name="right" [(ngModel)]="placement" value="right"
          >right</span
        >
      </div>
      <button
