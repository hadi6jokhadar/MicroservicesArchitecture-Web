...
import { ZardSheetService } from '../../../components/sheet/sheet.service';
...
@Component({
  ...
  template: `
    <div class="flex flex-col gap-4">
      <button z-button type="button" zType="outline" (click)="openWideSheet()">
        Wide Sheet (500px)
      </button>
      <button z-button type="button" zType="outline" (click)="openTallSheet()">
        Tall Sheet (80vh)
      </button>
      <button
        z-button
      ...
      <button z-button type="button" zType="outline" (click)="openTopSheet()">
        Top Sheet
      </button>
    </div>
  `,
