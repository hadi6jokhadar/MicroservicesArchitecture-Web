...
import { ZardCarouselPluginsService } from '../../../components/carousel/carousel-plugins.service';
import { ZardCarouselImports } from '../../../components/carousel/carousel.imports';
      ...
      >
        <z-carousel-content>
          ...
          <z-carousel-item>
            <z-card>
              <div
                class="flex h-40 items-center justify-center text-4xl font-semibold"
              >
                {{ slide }}
              </div>
            </z-card>
