...
import { ZardDropdownImports } from '../../../components/dropdown';
import { ZardIconComponent } from '../../../components/icon';
import { ZardInputDirective } from '../../../components/input/input.directive';
import { ZardInputGroupComponent } from '../../../components/input-group/input-group.component';
import { ZardTooltipDirective } from '../../../components/tooltip';
...
@Component({
  ...
  template: `
    ...
    <ng-template #info
      ><z-icon zType="info" zTooltip="Element with tooltip"
    /></ng-template>
