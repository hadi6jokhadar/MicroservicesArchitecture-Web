...
import { ZardCommandImports } from '../../../components/command/command.imports';
    ...
    <z-command class="md:min-w-125" (zCommandSelected)="handleCommand($event)">
      ...
      <z-command-list>
        ...
        <z-command-option-group zLabel="Navigation">
          <z-command-option
            zLabel="Go to Dashboard"
            zValue="dashboard"
            zIcon="layout-dashboard"
            zShortcut="⌘1"
          />
          <z-command-option
            zLabel="Go to Projects"
            zValue="projects"
            zIcon="folder"
            zShortcut="⌘2"
          />
